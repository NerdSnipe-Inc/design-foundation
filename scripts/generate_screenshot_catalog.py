...
def _pro_screens() -> list[CaptureTarget]:
    ...
    ids = [
        ...
        ("DFOnboardingWelcomeScreen", "Onboarding/Screens/DFOnboardingWelcomeScreen.swift"),
        ("DFOnboardingSignUpScreen", "Onboarding/Screens/DFOnboardingSignUpScreen.swift"),
        ("DFOnboardingSignInScreen", "Onboarding/Screens/DFOnboardingSignInScreen.swift"),
        ("DFOnboardingOTPScreen", "Onboarding/Screens/DFOnboardingOTPScreen.swift"),
        ("DFOnboardingProfileScreen", "Onboarding/Screens/DFOnboardingProfileScreen.swift"),
        ("DFOnboardingFeaturesScreen", "Onboarding/Screens/DFOnboardingFeaturesScreen.swift"),
        ("DFOnboardingPermissionsScreen", "Onboarding/Screens/DFOnboardingPermissionsScreen.swift"),
        ("DFOnboardingPlanScreen", "Onboarding/Screens/DFOnboardingPlanScreen.swift"),
        ("DFOnboardingPersonalisationScreen", "Onboarding/Screens/DFOnboardingPersonalisationScreen.swift"),
        ("DFOnboardingSuccessScreen", "Onboarding/Screens/DFOnboardingSuccessScreen.swift"),
